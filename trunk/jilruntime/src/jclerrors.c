...
const JCLErrorInfo JCLErrorStrings[JCL_Num_Compiler_Codes] =
{
	...
	0,	JCL_ERR_Ref_Arg_Conflict,			"Function redefined, inconsistent use of modifiers",
	0,	JCL_ERR_Arg_Type_Conflict,			"Function redefined, similar types",
	...
	3,	JCL_WARN_Post_IncDec_No_Effect,		"Post increment / decrement operator has no effect",
