...
#define JIL_LIBRARY_VERSION			JIL_PRODUCT_VERSION "3.89"
...
#define JIL_COMPILER_VERSION		JIL_PRODUCT_VERSION "3.57"
...
#define JIL_MACHINE_VERSION			JIL_PRODUCT_VERSION "3.19"
