...
#define JIL_LIBRARY_VERSION			JIL_PRODUCT_VERSION "3.41"
...
#define JIL_COMPILER_VERSION		JIL_PRODUCT_VERSION "3.26"
...
#define JIL_MACHINE_VERSION			JIL_PRODUCT_VERSION "3.16"
