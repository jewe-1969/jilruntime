...
#define JIL_LIBRARY_VERSION			JIL_PRODUCT_VERSION "4.19"
...
#define JIL_COMPILER_VERSION		JIL_PRODUCT_VERSION "4.7"
...
#define JIL_MACHINE_VERSION			JIL_PRODUCT_VERSION "4.1"
